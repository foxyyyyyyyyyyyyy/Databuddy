				...
				{!isAssistantPage && isTrackingSetupLoading ? (
					<div className="space-y-4 p-4">
						...
						<div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
							{[1, 2].map((num) => (
								<div
									className="overflow-hidden rounded border bg-accent/50"
								...
								>
									...
									<div className="space-y-2 px-3 pb-3">
										{Array.from({ length: 5 }).map((_, idx) => (
											<div
												className="flex items-center gap-3 rounded bg-sidebar-accent/20 p-3"
												key={`row-${num}-${idx}`}
											>
						...
						<div className="overflow-hidden rounded border bg-accent/50">
							<div className="p-3">
